...
public class FindTaskAdapterB extends RecyclerView.Adapter<FindTaskAdapterB.TaskViewHolder> {

    public Context context;

    public static ArrayList<TaskAttributes> mTaskAtr;

    public FindTaskAdapterB() {
    }

    public FindTaskAdapterB(Context context, ArrayList<TaskAttributes> taskAttributesList) {
